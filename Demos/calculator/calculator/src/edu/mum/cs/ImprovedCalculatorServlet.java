...
@WebServlet(name = "ImprovedCalculatorServlet" , urlPatterns = {"/"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(!("".equals(num1) && "".equals(num2))){
                ...
                out.println(" <input type=\"number\" name=\"num1\" value="+num1+"> + <input name=\"num2\" value="+num2+"> = <input name=\"sum\" value="+sum+" readonly>");
                out.println();
            }else{
                out.println("<input type=\"number\" name=\"num1\"> + <input name=\"num2\"> = <input name=\"sum\" readonly>");
                out.println();
            }
            out.print("<br/>");
